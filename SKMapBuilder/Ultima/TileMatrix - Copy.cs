...
{
    public class TileMatrix2 : UOFile
    {
        ...
        public TileMatrix2(string path, int width, int height) : base(path)
        {
            Width = width;
            Height = height;
        ...
        public TileMatrix2(int width, int height, short defaultTileId, sbyte defaultZ) : this(null, width, height)
        {
